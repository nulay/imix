...
<?php  if ($shopData && count($shopData['err'])!=0){ ?>
...
<form id="fChUser" class="fReg" enctype="multipart/form-data" action="/shop/registrationcompl" method="POST" style="padding:30px 0 0 50px; width:80%;"> 
...
<tr><td colspan=2 class='headerLabel'><label>Информация по магазину</label></td></tr>
<tr><td class='nameLabel'><label>Название магазина: *</label></td><td><input name="named" type="text" size="50" value="<?php print ($shopData && $shopData['named'])?$shopData['named']:""; ?>" style="margin-left:10px;"></td></tr>
<tr><td class='nameLabel'><label>Адрес магазина (физический): </label></td><td><textarea name="adres" rows="3" cols="38" style="margin-left:10px;"><?php print ($shopData && $shopData['adres'])?$shopData['adres']:""; ?></textarea></td></tr>
<tr><td class='nameLabel'><label>Электронный адрес магазина (название сайта): </label></td><td><input name="eladres" type="text" size="50" value="<?php print ($shopData && $shopData['eladres'])?$shopData['eladres']:""; ?>" style="margin-left:10px;"></td></tr>
<tr><td class='nameLabel'><label>E-mail магазина (менеджера): *</label></td><td><input name="email" type="text" size="30" value="<?php print ($shopData && $shopData['email'])?$shopData['email']:""; ?>" style="margin-left:10px;"></td></tr>
<tr><td class='nameLabel'><label>Описание магазина<br>(выводится на странице о магазине): </label></td><td><textarea name="aboutshop" rows="3" cols="38" style="margin-left:10px;"><?php print ($shopData && $shopData['aboutshop'])?$shopData['aboutshop']:""; ?></textarea></td></tr>
...
<tr><td class='nameLabel'><label>Логотип магазина (не более 300кб и тип jpeg, png, gif): </label></td><td><input type="file" class="file" name="logo" size="30" value="" style="margin-left:10px;"></td></tr>
...
<tr><td colspan=2 class='headerLabel'><label>Информация о валюте</label></td></tr>
<tr><td class='nameLabel'><label>Курс доллара к белорускому рублю 1$=: *</label></td><td><input name="priceDollar" type="text" size="30" value="<?php print ($shopData && $shopData['priceDollar'])?$shopData['priceDollar']:""; ?>" style="margin-left:10px;"></td></tr>
...
<tr><td colspan=2 class='battonPanel'><input type='submit' value='Зарегистрировать магазин'/></td></tr>
